...
const trustPoints = [
  { icon: Clock, text: "Term sheet in 24–48 hours" },
        ...
        <div className="section-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-white mt-2">
              Get Your Term Sheet in 24–48 Hours
            </h1>
            ...
            <div className="card">
              ...
              >
                ...
                <fieldset className="flex flex-col gap-5">
                  ...
                  <div>
                    <label htmlFor="borrowerType" className="form-label">
                      I am a... *
                    </label>
                    <select
                      id="borrowerType"
                ...
                <fieldset className="flex flex-col gap-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="arv" className="form-label">
                      ...
                      <input
                        ...
                        type="text"
                        className="form-input"
                        placeholder="$600,000 (for Fix & Flip)"
                      />
                    </div>
                  </div>

                  <div>
                    <label htmlFor="exitStrategy" className="form-label">
                      Exit Strategy *
                    </label>
                    <select
                      id="exitStrategy"
                ...
                <fieldset className="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Rehab scope, deal specifics, timeline constraints, or questions for us..."
                    />
                  </div>
                </fieldset>
