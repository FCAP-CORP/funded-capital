...
Funded Capital is a Miami-based private lender financing investor real estate across **45 states**. [Fix & Flip loans](/fix-and-flip-loans) start at **8.75%** with up to **90% LTC** including rehab funds on a structured draw schedule, [new construction financing](/new-construction-loans) starts at **8.75%** with up to **85% LTC**, and [DSCR loans](/dscr-loans) start at **6.0%** with up to **80% LTV** — with **no income verification** on most programs and lending to LLCs as standard.
