...
Funded Capital is a Miami-based private lender serving real estate investors in 45 states. On our DSCR loans, the property's income qualifies the deal — no income verification, no tax returns, no W-2s.
