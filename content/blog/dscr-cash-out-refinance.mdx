...
Funded Capital is a Miami-based private lender serving real estate investors in 45 states. On a DSCR cash-out refinance, the property's rental income qualifies the deal — no income verification, no tax returns, no W-2s.
