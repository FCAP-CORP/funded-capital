...
Funded Capital is a Miami-based private lender built for investors who need to move fast. We finance fix and flip loans from 8.75% with up to 90% loan-to-cost, and we lend across 45 states. We underwrite the deal — the property, the budget, and the projected resale value — not your paperwork.
