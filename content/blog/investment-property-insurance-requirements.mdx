...
Then let the rest of the file move. Fix & Flip from 8.75% up to 90% LTC. DSCR from 6.0% up to 80% LTV, no income verification. New Construction from 8.75%. Multifamily bridge and term. Nationwide across 45 states, underwritten on the asset and the business plan rather than your tax returns.
