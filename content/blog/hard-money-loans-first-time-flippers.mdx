...
Funded Capital is a Miami-based private lender financing real estate investors across **45 states**. [Fix & flip loans](/fix-and-flip-loans) start at **8.75%** with up to **90% LTC** including rehab funds. When you're ready to hold instead of sell, [DSCR loans](/dscr-loans) start at **6.0%** with up to **80% LTV** — with **no income verification** on most programs — and [new construction financing](/new-construction-loans) starts at **8.75%** with up to **85% LTC**.
