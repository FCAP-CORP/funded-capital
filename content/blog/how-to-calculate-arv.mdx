...
Funded Capital is a Miami-based private lender built for investors who need to move quickly on strong deals. We finance [fix and flip loans](/fix-and-flip-loans) from 8.75% with up to 90% loan-to-cost, and we lend across 45 states. We underwrite the deal — the purchase price, the renovation budget, and the after-repair value — not your tax returns.
